...
final class MaxLength implements FieldValidator
{
    ...
    {
        if (is_bool($value)) {
            throw new ValidationException('You cannot insert a boolean value to Max Length validator.');
        }
        ...
        $exception = new ValidationFieldException($this->fieldName, ValidationBuilder::MAX_LENGTH . ":{$this->length}");
